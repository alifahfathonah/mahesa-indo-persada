                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <form action="/admin-area/booking" method="GET">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td>{{ $row->booking_pelanggan }}</td>
                                        <td>{{ $row->booking_blok }}</td>
                                        <td>{{ $row->perumahan->perumahan_nama }}</td>
                                        <td>{{ $row->booking_keterangan }}</td>
